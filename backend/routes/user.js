...
const { listAuthUsers, getAuthUser, updateAuthUser, deleteAuthUser, batchDeleteAuthUsers } = require("../controllers/authUserAdminController");
...
router.post("/users/batch-delete", requireAuth, requireAdmin, batchDeleteAuthUsers);
